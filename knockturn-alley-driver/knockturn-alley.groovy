...
@Field static final Map ZCL_CLUSTERS = [
    ...
    0x0102: [
        ...
        attributes: [
            0x0000: [req:'req', acc:'r--', name:'Window Covering Type', constraints: [
                0x00: 'Rollershade',
            ...
            0x0010: [req:'req', acc:'r--', name:'Installed Open Limit - Lift'],
            0x0011: [req:'req', acc:'r--', name:'Installed Closed Limit - Lift'],
            0x0012: [req:'req', acc:'r--', name:'Installed Open Limit - Tilt'],
            0x0013: [req:'req', acc:'r--', name:'Installed Closed Limit - Tilt'],
            0x0014: [req:'opt', acc:'rw-', name:'Velocity - Lift'],
            0x0015: [req:'opt', acc:'rw-', name:'Acceleration Time - Lift'],
            0x0016: [req:'opt', acc:'rw-', name:'Deceleration Time - Lift'],
            0x0017: [req:'req', acc:'rw-', name:'Mode'],
            0x0018: [req:'opt', acc:'rw-', name:'Intermediate Setpoints - Lift'],
            0x0019: [req:'opt', acc:'rw-', name:'Intermediate Setpoints - Tilt' ]
       ],
        commands: [
