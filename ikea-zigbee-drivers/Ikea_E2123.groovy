...
metadata {
    definition(name:DRIVER_NAME, namespace:'dandanache', author:'Dan Danache', importUrl:'https://raw.githubusercontent.com/dan-danache/hubitat/master/ikea-zigbee-drivers/Ikea_E2123.groovy') {
        ...
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0001,0003,0020,1000,FC57', outClusters:'0003,0004,0006,0008,0019,1000,FC7F', model:'SYMFONISK sound remote gen2', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // Firmware: 1.0.012
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0001,0003,0020,1000,FC7C', outClusters:'0003,0004,0006,0008,0019,1000', model:'SYMFONISK sound remote gen2', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // Firmware: 1.0.35 (117C-110E-01000035)
    ...
    preferences {
        input(
            ...
            <div style="min-height:55px; background:transparent url('https://dan-danache.github.io/hubitat/ikea-zigbee-drivers/img/Ikea_E2123.webp') no-repeat left center;background-size:auto 55px;padding-left:60px">
                IKEA Symfonisk Sound Remote Gen2 (E2123) <small>v5.1.0</small><br>
                <small><div>
