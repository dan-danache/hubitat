...
metadata {
    definition(name:DRIVER_NAME, namespace:'dandanache', author:'Dan Danache', importUrl:'https://raw.githubusercontent.com/dan-danache/hubitat/master/ikea-zigbee-drivers/Xiaomi_LYWSD03MMC.groovy') {
        ...
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0001,0405,0402,0204', outClusters:'0019', model:'LYWSD03MMC', manufacturer:'Xiaomi', controllerType:'ZGB' // Firmware: /devbis/z03mmc
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0001,0003,0020,0204,0402,0405', outClusters:'0019', model:'LYWSD03MMC-z', manufacturer:'Xiaomi', controllerType:'ZGB' // Firmware: /pvvx/ZigbeeTLc
    ...
    preferences {
        input(
            ...
            <div style="min-height:55px; background:transparent url('https://dan-danache.github.io/hubitat/ikea-zigbee-drivers/img/Xiaomi_LYWSD03MMC.webp') no-repeat left center;background-size:auto 55px;padding-left:60px">
                Xiaomi Mi Temperature and Humidity Monitor 2 (LYWSD03MMC) <small>v5.4.0</small><br>
                <small><div>
