...
metadata {
    definition(name:DRIVER_NAME, namespace:'dandanache', author:'Dan Danache', importUrl:'https://raw.githubusercontent.com/dan-danache/hubitat/master/ikea-zigbee-drivers/Ikea_E1745.groovy') {
        ...
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0001,0003,0020,1000,FC57,FC7C', outClusters:'0003,0004,0006,0008,0019,1000', model:'TRADFRI motion sensor', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // Firmware: 24.4.5 (117C-11C8-24040005)
    ...
    preferences {
        input(
            ...
            <div style="min-height:55px; background:transparent url('https://dan-danache.github.io/hubitat/ikea-zigbee-drivers/img/Ikea_E1745.webp') no-repeat left center;background-size:auto 55px;padding-left:60px">
                IKEA Tradfri Motion Sensor (E1745) <small>v5.1.0</small><br>
                <small><div>
