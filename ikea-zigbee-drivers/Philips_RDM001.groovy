...
metadata {
    definition(name:DRIVER_NAME, namespace:'dandanache', author:'Dan Danache', importUrl:'https://raw.githubusercontent.com/dan-danache/hubitat/master/ikea-zigbee-drivers/Philips_RDM001.groovy') {
        ...
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0001,0003,FC00', outClusters:'0003,0004,0006,0008,0019', model:'RDM001', manufacturer:'Signify Netherlands B.V.', controllerType:'ZGB' // Firmware: 1.0.5 (100B-011C-0000041A)
    ...
    preferences {
        input(
            ...
            <div style="min-height:55px; background:transparent url('https://dan-danache.github.io/hubitat/ikea-zigbee-drivers/img/Philips_RDM001.webp') no-repeat left center;background-size:auto 55px;padding-left:60px">
                Philips Hue Wall Switch Module (RDM001) <small>v5.4.0</small><br>
                <small><div>
