...
The **Hubitat Hub** consults its suite of applications, such as Rule Machine, Button Controller, and Room Lighting, to determine if an automation task is triggered by the reported event.
Upon identifying a relevant automation task, the **Hubitat** Hub executes the associated actions. In the example provided, it issues a "turn on" command to the **Light Switch**.
...
└──────┬──────┘          └─────┬─────┘└───────┬───────┘└───────┬───────┘
       ...
       │                       │              │                │        
       │                       │              │                │        
       │        2a. Broadcast command         │                │        
       │            [turn on]  │              │                │        
       │                       │              │                │        
       │─────────────────────────────────────>│                │        
       │                       │              │                │        
       │                       │              │                │        
       │                2b. Broadcast command │                │        
       │                    [turn on]         │                │        
       │                       │              │                │        
       │──────────────────────────────────────────────────────>│        
┌──────┴──────┐          ┌─────┴─────┐┌───────┴───────┐┌───────┴───────┐
...
* Parasoll Door/Window Sensor (E2013): On/Off functionality
* Rodret Dimmer (E2201): On/Off and Brightness control
* Symfonisk Sound Remote Gen2 (E2123): On/Off functionality
