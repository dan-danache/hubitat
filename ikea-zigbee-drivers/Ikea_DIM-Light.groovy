...
metadata {
    definition(name:DRIVER_NAME, namespace:'dandanache', author:'Dan Danache', importUrl:'https://raw.githubusercontent.com/dan-danache/hubitat/master/ikea-zigbee-drivers/Ikea_DIM-Light.groovy') {
        ...
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,1000,FC7C', outClusters:'0019', model:'TRADFRI bulb E27 WW globe 806lm', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // LED2103G5: 1.0.36 (117C-2100-01000036)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,1000,FC7C', outClusters:'0019', model:'TRADFRI bulb GU10 WW 345lm8', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // LED2104R3: 1.0.36 (117C-2100-01000036)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,1000,FC7C', outClusters:'0005,0019,0020,1000', model:'TRADFRI bulb E27 opal 1000lm', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // LED1623G12: 2.3.094 (117C-2101-23094631)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,1000,FC7C', outClusters:'0005,0019,0020,1000', model:'TRADFRI bulb E14 W op/ch 400lm', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // LED1649C5E14EU: 2.3.094 (117C-2101-23094631)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,1000,FC57', outClusters:'0019', model:'TRADFRIbulbE27WWclear250lm', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // LED1934G3: 1.0.010 (117C-2102-00010010)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,0B05,1000', outClusters:'0005,0019,0020,1000', model:'TRADFRI Driver 10W', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // 10EU-IL-1: 1.2.245 (117C-4101-12245572)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,1000,FC7C', outClusters:'0005,0019,0020,1000', model:'TRADFRI Driver 10W', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // 10EU-IL-1: 2.3.086 (117C-4101-23086631)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,1000,FC7C', outClusters:'0005,0019,0020,1000', model:'TRADFRI bulb GU10 WW 400lm', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // LED1837R5: 2.3.093 (117C-4103-23093631)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,1000,FC7C', outClusters:'0005,0019,0020,1000', model:'TRADFRI bulb E27 WW clear 250lm', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // LED1842G3: 2.3.093 (117C-4103-23093631)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,1000,FC7C', outClusters:'0005,0019,0020,1000', model:'TRADFRI bulb E27 WW 806lm', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // LED1836G9: 2.3.094 (117C-4103-23093631)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,1000,FC57', outClusters:'0019', model:'SILVERGLANS IP44 LED driver', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // 30-IL44-1: 1.0.021 (117C-4104-00010021)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0003,0004,0005,0006,0008,1000,FC57', outClusters:'0019', model:'TRADFRI Driver 30W', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // 30EU-IL-2: 1.0.002 (117C-4109-00010002)
    ...
    preferences {
        input(
            ...
            <div style="min-height:55px; background:transparent url('https://dan-danache.github.io/hubitat/ikea-zigbee-drivers/img/Ikea_DIM-Light.webp') no-repeat left center;background-size:auto 55px;padding-left:60px">
                IKEA Dimmable Light <small>v5.4.1</small><br>
                <small><div>
