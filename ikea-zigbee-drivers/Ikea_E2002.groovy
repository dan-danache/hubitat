...
metadata {
    definition(name:DRIVER_NAME, namespace:'dandanache', author:'Dan Danache', importUrl:'https://raw.githubusercontent.com/dan-danache/hubitat/master/ikea-zigbee-drivers/Ikea_E2002.groovy') {
        ...
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0001,0003,0020,1000,FC57', outClusters:'0003,0006,0008,0019,1000', model:'Remote Control N2', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // Firmware: 1.0.024
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0001,0003,0020,1000,FC57,FC7C', outClusters:'0003,0005,0006,0008,0019,1000', model:'Remote Control N2', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // Firmware: 2.4.5 (117C-11CB-02040005)
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0001,0003,0004,0020,1000,FC7C', outClusters:'0003,0004,0005,0006,0008,0019,1000', model:'Remote Control N2', manufacturer:'IKEA of Sweden', controllerType:'ZGB' // Firmware: 2.4.11 (117C-11CB-02040011)
    ...
    preferences {
        input(
            ...
            <div style="min-height:55px; background:transparent url('https://dan-danache.github.io/hubitat/ikea-zigbee-drivers/img/Ikea_E2002.webp') no-repeat left center;background-size:auto 55px;padding-left:60px">
                IKEA Styrbar Remote Control N2 (E2002) <small>v5.1.0</small><br>
                <small><div>
