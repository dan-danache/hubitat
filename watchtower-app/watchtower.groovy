...
Map changelog() {
    dynamicPage(name:'changelog', title:'Change log', install:false, uninstall:false) {
        section('v2.0.1 - 2024-09-30', hideable:true, hidden:false) {
            paragraph '''\
                <ul>
                    <li><b>Fixed</b>: Fix <code>IndexOutOfBoundsException</code> when the last value on a record line is null (empty string) - @iEnam
                </ul>
            '''
        }
        section('v2.0.0 - 2024-09-14', hideable:true, hidden:true) {
            paragraph '''\
                <ul>
                    <li><b>Added</b>: Add support for aggregated min/max values
                    <li><b>Changed</b>: Remove bar chart rendering when fewer datapoints are available
                    <li><b>Changed</b>: Null values in CSV files are now saved as empty strings instead of using dashes (-)
                </ul>
            '''
        }
        section('v1.5.0 - 2024-08-27', hideable:true, hidden:true) {
            paragraph '''\
                <ul>
        ...
        section('v1.4.0 - 2024-08-22', hideable:true, hidden:true) {
            paragraph '''\
                <ul>
                    <li><b>Changed</b>: Rewrite chart zoom mechanism to no longer rely on mouse scroll
                </ul>
            '''
        }
        section('v1.3.2 - 2024-08-19', hideable:true, hidden:true) {
            paragraph '''\
                <ul>
                    <li><b>Fixed</b>: Display decimal points in chart data - @bobbles
                </ul>
            '''
        }
        section('v1.3.1 - 2024-08-16', hideable:true, hidden:true) {
            paragraph '''\
                <ul>
                    <li><b>Fixed</b>: Fix situations where tooltip is obscured by the time resolution picker or the chart title - @an39511
                </ul>
            '''
        }
        section('v1.3.0 - 2024-08-15', hideable:true, hidden:true) {
            paragraph '''\
                <ul>
        ...
        section('v1.2.0 - 2024-08-11', hideable:true, hidden:true) {
            paragraph '''\
                <ul>
